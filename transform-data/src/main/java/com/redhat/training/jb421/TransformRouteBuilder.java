...
public class TransformRouteBuilder extends RouteBuilder {
	public static String OUTPUT_FOLDER = "/home/ihsan/jboss-fuse/transform-data/orders/outgoing";
	...
	public void configure() throws Exception {
		...
		from("jpa:com.redhat.training.jb421.model.Order?persistenceUnit=mysql" + "&consumeDelete=false"
				+ "&consumer.namedQuery=getUndeliveredOrders" + "&consumer.delay=" + BATCH_TIMEOUT
				+ "&consumeLockEntity=false")
						...
						// TODO aggregate the order items based on their catalog
						// item id
						.aggregate(xpath("orderItem/catalogItem/id"), new ReservationAggregationStrategy())
						.completionInterval(BATCH_TIMEOUT).completeAllOnStop()
