...
public class HeaderProcessor implements Processor {
	...
	final private static String QUEUE_URI = "activemq:queue:namming";

	//	final private static String XPATH_VENDOR = "/order/orderItems/orderItem/orderItemPublisher/text()";
