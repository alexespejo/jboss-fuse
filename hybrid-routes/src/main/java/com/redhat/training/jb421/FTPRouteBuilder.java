...
public class FTPRouteBuilder extends RouteBuilder {
	...
	public void configure() throws Exception {
		...
		from(FTP_SERVER + SRC_FOLDER2 + FTP_OPTIONS).to(DIRECT)
				.log("Alamat server : " + FTP_SERVER + SRC_FOLDER2 + FTP_OPTIONS);
		from(FTP_SERVER + SRC_FOLDER3 + FTP_OPTIONS).to(DIRECT)
				.log("Alamat server : " + FTP_SERVER + SRC_FOLDER3 + FTP_OPTIONS);
	}
